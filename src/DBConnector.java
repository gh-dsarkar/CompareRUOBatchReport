...
public class DBConnector {
    ...
    public static HashMap<String,ArrayList<String>> reportType;
    ...
    private static boolean compareRecords(HashMap<String,String> resultHashMap, HashMap<String,String> VariantResultMap) throws IOException {
        ...
        switch (reportOption){
            case 1:
                ...
                break;
            case 2:
                    reportType = reportType_2;
                    break;
            case 3:
                        reportType = reportType_3;
                        break;
            case 4:
                reportType = reportType_4;
                break;

            case 5:
                reportType = reportType_5;
                break;

            case 6:
                reportType = reportType_6;
                break;

            case 7:
                reportType = reportType_7;
                break;
            case 8:
                reportType = reportType_8;
                break;
            case 9:
                reportType = reportType_9;
                break;
            case 10:
                reportType = reportType_10;
                break;
            case 11:
                reportType = reportType_11;
                break;

            case 12:
                reportType = reportType_12;
                break;
            case 13:
                reportType = reportType_13;
                break;

            case 14:
                reportType = reportType_14;
                break;

            case 15:
                reportType = reportType_15;
                break;

        }
        if (!reportType.get(VariantResultMap.get("Variant_type")).contains(VariantResultMap.get("Gene"))){
            if (!reportType.get(VariantResultMap.get("Variant_type")).contains("All")) {
...
//            String temp = repType.replaceAll("\"", "\'");  //WHERE REPORTMODULE = '"+temp+"'"
        ...
        switch (reportOption) {
            ...
            case 10: //RUO-BASE+HRD+methylation
            {
                while (reportType.next()) {
                    if ((reportType.getString(3).equalsIgnoreCase("base")) ||
                            (reportType.getString(3).equalsIgnoreCase("HRD")) ||
